...
public class translate {
    ...
    public void memriseElements(String chromeDrivePath,String directory,String fileName,String fileName2,String sourceFile){
        ...
        try{
            ...
            while(scanner != null && scannerNtv != null){
                ...
                driver.findElement(By.xpath("//*[@id=\"l_13391990\"]/div[3]/table/tbody[2]/tr[2]/td[2]/input")).sendKeys(addForeign);
                driver.findElement(By.xpath("//*[@id=\"l_13391990\"]/div[3]/table/tbody[2]/tr[2]/td[3]/input")).sendKeys(addNative);
    ...
    public static void main(String[] args) {
        ...
        tr.memriseElements(chromeDrivePath,directory,"foreign.txt","native.txt","GitKomut.txt");
        //tr.findGitMethod();
